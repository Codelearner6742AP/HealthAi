    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-full border border-gray-300 dark:border-gray-700 shadow-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent"
              />
              <svg
        ...
        <section className="py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {doctors.map((doctor) => (
              <Card
                key={doctor.id}
                className="h-full border-gray-200 dark:border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Browse our directory of qualified healthcare professionals and find the right specialist for your needs.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Connect via WhatsApp</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Initiate a consultation through WhatsApp with just one click. No downloads or registrations required.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Receive professional medical advice and personalized recommendations from the comfort of your home.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 mb-8">
          <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 md:p-8">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Our platform connects you with specialists across various health domains. Get personalized care from
